    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(db_index=True, max_length=12, unique=True, verbose_name='Phone number')),
                ...
                ('middle_name', models.CharField(max_length=50, null=True, verbose_name='Last name')),
